...
# 10001 - 19999 - discrete input contacts R/O - binary
    ...
    with dpg.collapsing_header(label="Configure Coils / Contacts "):
        dpg.add_text("Use this to set binary values on a Modbus Server", tag="setCoilText")
        dpg.add_text("Address to Configure (1-65535):", tag="setCoilAddressText")
        ...
        dpg.add_text("Set Value", tag="setCoilAddressNewValueText")
