...
class modbusServer:
    ...
    def connect(self):
        ...
        self.modbusClientObj.host = self.address
        self.debugLog("Set hostname")
          
        self.modbusClientObj.port = int(self.port)
    ...
    def scanCoils(self, min, max, dpg = None, progressBar = None):
        self.debugLog("ScanCoils - min: " + str(min) + " max: " + str(max))
        if self.connected == False:
            self.debugLog("scan called but not connected")
            return False

        self.clearCoilsArray()
    ...
    def clearCoilsArray(self):
        self.debugLog("clearCoilsArray - Clearing Coil Data")
        self.coilArray = False
        self.coilArray = list()
        self.coilCount = 0
