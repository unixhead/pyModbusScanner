...
with dpg.window(tag="Primary Window"):
    ...
    dpg.add_input_text(default_value="Not Yet Scanned...", tag="configuredRegisters" , readonly=True, multiline=True)
    ...
    dpg.add_input_text(default_value="Not Yet Scanned...", tag="configuredInputRegisters" , readonly=True, multiline=True)
